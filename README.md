...
The Winner: The winner is the last person to have placed a bid. They are the bidder who was willing to go the highest and was not outbid by anyone else.

The Price: The winner pays the price of their final, highest bid.
...
# A Deeper Insight (How It Relates to the Simulation)

This simple strategy leads to a very interesting outcome, which is what our Python simulation was built on.
Imagine Bidder A values the item at $200$.
Imagine Bidder B values the item at $150$.
The bidding will start low and both will bid.
The price will eventually pass $150$.
At this point, Bidder B (who only values it at $150$) will drop out, following the optimal strategy.
...
This is also why, as the simulation shows, the English Auction is 100% efficient: the item always goes to the person who values it the most.
